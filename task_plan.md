...
### Add-on: Learning / EICE / PSC / Social (Library SKIPPED)
- [x] Learning `lib/features/learning/domain/entities/learning.dart:1` `learning_dto.dart:1` `learning_remote_data_source.dart:1` `GET /learning/tracks` + `/today` + `/reviews/due` + `POST /learning/tutor` non-streaming, `LearningHomeScreen` + `AiTutorScreen` `lib/features/learning/presentation/screens/learning_home_screen.dart:1`, route `/learning` `lib/app/router/app_router.dart:1`
- [x] EICE `lib/features/eice/data/eice_remote_data_source.dart:1` `GET /quiz/study-planner/{exam}/coach|/triage` + `GET /quiz/sprint` + `GET /quiz/reports/weekly`, `EiceScreen` `lib/features/eice/presentation/eice_screen.dart:1`, route `/eice`
- [x] PSC `lib/features/psc/data/psc_remote_data_source.dart:1` `GET /psc/blueprints` + `POST /blueprints/{id}/exam|/submit`, `PscScreen` `lib/features/psc/presentation/psc_screen.dart:1`, route `/psc`
- [x] Social `lib/features/social/presentation/social_screen.dart:1` native `SharePlus` + leaderboard/referral placeholder, `Economy` `lib/features/economy/presentation/economy_screen.dart:1` coins via `GET /me`, `Search` `lib/features/search/presentation/search_screen.dart:1` `GET /quiz/questions?search=`, `Notifications` `lib/features/notifications/presentation/notifications_screen.dart:1` `GET /notifications`, `Profile` enhanced `lib/features/profile/presentation/screens/profile_screen.dart:1` hub to all, routes `/social|/economy|/search|/notifications` `lib/app/router/app_router.dart:1`
- [x] **Library SKIPPED** — `C:\laragon\www\bisaas\routes\api\v1\library.php` backend not completed per user; no `lib/features/library` to avoid AI drift. Deferred until backend ships `GET /library/files` etc. Both agents skip.
- **Status:** complete (6/6 done, library intentionally skipped, lib analyze 0)
