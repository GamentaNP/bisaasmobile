...
void main() {
  test('v1 → v2: questions rebuilt, new tables created, sync_queue unique index enforced', () async {
    ...
    // ── Open through drift: user_version 1 < schemaVersion 2 → onUpgrade ───
    ...
    // v2 tables exist.
    for (final t in ['quiz_attempts', 'downloads', 'cached_responses']) {
